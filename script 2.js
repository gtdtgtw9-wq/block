(() => {
  ...
  const BLOCK_AREA_HEIGHT_RATIO = 0.6; // 画面高さに対するブロックエリアの最大割合
  ...
  function resize() {
    ...
    blockAreaTop = 64;
    const maxAreaHeight = H * BLOCK_AREA_HEIGHT_RATIO;
    let areaHeight = maxAreaHeight;
    let areaWidth = areaHeight * IMAGE_ASPECT;
    if (areaWidth > W) {
      areaWidth = W;
      areaHeight = areaWidth / IMAGE_ASPECT;
    }
